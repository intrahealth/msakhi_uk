...
public class Reportindicator_anmHnbclist extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btndetails.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(Reportindicator_anmHnbclist.this, AshaDashboardListHnbc.class);
				finish();
				startActivity(i);
			}
		});
	...
	public void showdatalastMonth() {
		...
		String Sql1 = "";
		Sql1 = "select  count(*) from tblPNChomevisit_ANS  inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID  where ((select count(VisitNo) from tblPNChomevisit_ANS inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID) >=7) and place_of_birth=1 and tblPNChomevisit_ANS.ANMID = "+anmid+" and (Date(Q_0) Between Date('"
		+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue1 = 0;
		iValue1 = dataprovider.getMaxRecord(Sql1);

		String Sql1query = "";
		Sql1query = "select  count(*) from tblPNChomevisit_ANS  inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID  where place_of_birth=1 and tblPNChomevisit_ANS.ANMID = "+anmid+" and (Date(Q_0) Between Date('"
				+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue1query = 0;
		...
		String Sql2 = "";
		Sql2 = "select  count(*) from tblPNChomevisit_ANS  inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID  where ((select count(VisitNo) from tblPNChomevisit_ANS inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID) >=6) and place_of_birth=2 and tblPNChomevisit_ANS.ANMID = "+anmid+" and (Date(Q_0) Between Date('"
				+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue2 = 0;
		iValue2 = dataprovider.getMaxRecord(Sql2);

		String Sql2query = "";
		Sql2query = "select  count(*) from tblPNChomevisit_ANS  inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID  where place_of_birth=2 and tblPNChomevisit_ANS.ANMID = "+anmid+" and (Date(Q_0) Between Date('"
				+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue2query = 0;
		...
		String Sql3 = "";
		Sql3 = "select  count(*) from tblPNChomevisit_ANS inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID  where ((select count(VisitNo) from tblPNChomevisit_ANS inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID) >=2) and (date(Child_dob) < (select date(Child_dob,'+0 month','+7 day') from tblPNChomevisit_ANS inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID)) and place_of_birth = 1 and tblPNChomevisit_ANS.ANMID = "
		+anmid+" and (Date(Q_0) Between Date('"
		+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue3 = 0;
		iValue3 = dataprovider.getMaxRecord(Sql3);

		String Sql3query = "";
		Sql3query = "select  count(*) from tblChild where ANMID = "+anmid+" and place_of_birth = 1 and (Date(Child_dob) Between Date('"
				+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue3query = 0;
		...
		String Sql5 = "";
		Sql5 = "select  count(*) from tblPNChomevisit_ANS  inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID  where ((select count(VisitNo) from tblPNChomevisit_ANS inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID) >=2) and (date(Child_dob) < (select date(Child_dob,'+0 month','+7 day') from tblPNChomevisit_ANS inner join tblChild on tblPNChomevisit_ANS.ChildGUID=tblChild.ChildGUID)) and place_of_birth=2 and tblPNChomevisit_ANS.ANMID = "
		+anmid+" and (Date(Q_0) Between Date('"
				+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue5 = 0;
		...
		String Sql6 = "";
		Sql6 = "select  count(*) from tblChild  where Wt_of_child < 2.5 and ANMID = "+anmid+" and (Date(Child_dob) Between Date('"
				+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue6 = 0;
		iValue6 = dataprovider.getMaxRecord(Sql6);

		String sql6query = "";
		sql6query = "select  count(*) from tblChild where Wt_of_child != 'null' and Wt_of_child != 0 and ANMID = "+anmid+" and (Date(Child_dob) Between Date('"
				+lastmonthStartDate+"') and Date('"+lastMonthEndDate+"'))";
		int iValue6query = 0;
