...
import com.microware.intrahealth.ReportIndicatorListHH;
import com.microware.intrahealth.dataprovider.DataProvider;
import com.microware.intrahealth.object.MstASHA;

@SuppressLint("InflateParams")
public class AshaDashboardListFormHH_Adapter extends BaseAdapter {
	...
	public AshaDashboardListFormHH_Adapter(Context context, ArrayList<MstASHA> ashaname) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		txtAshaName.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(context, ReportIndicatorListHH.class);
