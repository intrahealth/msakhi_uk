...
public class HomeVisitAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			gridview = layoutInflater.inflate(R.layout.homevisit_gridadapter, null);
		} else {
...
//			imagedelete.setEnabled(false);
		...
		tvsno.setText(context.getResources().getString(R.string.visit) + "-" + String.valueOf(VisitANC.get(position).getVisit_No()));
		tvlastvisit.setText(VisitANC.get(position).getHomeVisitDate());
...
//				global.setiCurrentActiveTab(0);
				...
				Intent in = new Intent(context, AncQuestionActivity.class);
