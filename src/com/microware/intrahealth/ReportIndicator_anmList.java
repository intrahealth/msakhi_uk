...
public class ReportIndicator_anmList extends Activity {
	...
	public void showdatafooLastMonth() {
		...
		String sql1 = "";
		sql1 = "select  count(*) from tblPregnant_woman where IsPregnant=1 and ANMID = "
				+ anmid
		...
		String sql2 = "";
		sql2 = "select  count(*) from tblPregnant_woman where IsPregnant=1 and ANMID = "
				+ anmid
				+ " and (Date(PWRegistrationDate) Between Date('"
				+ lastmonthStartDate
				+ "') and Date('"
		...
		String sql3 = "";
		sql3 = "select  count(*) from tblANCVisit where Visit_No=1 and CheckupVisitDate is not null and ByANMID = "
				+ anmid
		...
		String sql3Query = "";
		sql3Query = "select  count(*) from tblPregnant_woman where where IsPregnant=0 and ANMID = "
				+ anmid
				+ " and (Date(CheckupVisitDate) Between Date('"
				+ lastmonthStartDate
				+ "') and Date('"
		...
		String sql4 = "";
		sql4 = "select  count(*) from tblANCVisit where Visit_No=2 and CheckupVisitDate is not null and ByANMID = "
				+ anmid
				+ " and (Date(CheckupVisitDate) Between Date('"
				+ lastmonthStartDate
				+ "') and Date('"
		...
		String sql5 = "";
		sql5 = "select  count(*) from tblANCVisit where Visit_No=3 and CheckupVisitDate is not null and ByANMID = "
				+ anmid
				+ " and (Date(CheckupVisitDate) Between Date('"
				+ lastmonthStartDate
				+ "') and Date('"
		...
		String sql6 = "";
		sql6 = "select  count(*) from tblANCVisit where Visit_No=4 and CheckupVisitDate is not null and ByANMID = "
				+ anmid
				+ " and (Date(CheckupVisitDate) Between Date('"
				+ lastmonthStartDate
				+ "') and Date('"
		...
		String sql7 = "";
		sql7 = "select  count(*) from tblANCVisit where TTsecondDoseDate is not null or TTboosterDate is not null and ByANMID = "
				+ anmid
		...
		String Sql8 = "";
		Sql8 = "select  count(*) from tblPregnant_woman where DeliveryPlace=2 and ANMID = "
				+ anmid
