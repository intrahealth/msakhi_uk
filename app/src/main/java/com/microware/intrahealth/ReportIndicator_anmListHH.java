...
public class ReportIndicator_anmListHH extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reportindicator_anmlisthh);
    ...
    public void showData(int villageID) {
        try {
            String sql1 = "";
            sql1 = "select  count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember  on Tbl_HHSurvey.HHSurveyGUID=Tbl_HHFamilyMember.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and  Tbl_HHFamilyMember.GenderID=1 and  Tbl_HHSurvey.VillageID='" + villageID + "' and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue1 = 0;
            ivalue1 = dataProvider.getMaxRecord(sql1);
            tv_totalpopulationmale.setText(String.valueOf(ivalue1));
            String sql1female = "";
            sql1female = "select  count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember  on Tbl_HHSurvey.HHSurveyGUID=Tbl_HHFamilyMember.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   Tbl_HHFamilyMember.GenderID=2 and  Tbl_HHSurvey.VillageID='" + villageID + "' and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue1female = 0;
            ...
            String sql3 = "";
            sql3 = "select count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember member on Tbl_HHSurvey.HHSurveyGUID=member.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   Tbl_HHSurvey.VillageID='" + villageID + "' and  member.Genderid=2 and Tbl_HHSurvey.ANMID= " + anmid + " and (((Date('now') ) - (DATE(member.DateOfBirth)) >=15 and (Date('now') ) - (DATE(member.DateOfBirth)) <=49) or (AprilAgeYear >=15 and AprilAgeYear<=49) )";
            int ivalue3 = 0;
            ...
            String sql4 = "";
            sql4 = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=1 and Tbl_HHSurvey.VillageID='" + villageID + "' and (julianday('now')  - julianday(member.child_dob))<=180 and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue4 = 0;
            ivalue4 = dataProvider.getMaxRecord(sql4);
            tv_0to6monthfemale.setText(String.valueOf(ivalue4));

            String sql4boy = "";
            sql4boy = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and    member.Gender=2 and Tbl_HHSurvey.VillageID='" + villageID + "' and (julianday('now')  - julianday(member.child_dob))<=180 and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue4boy = 0;
            ...
            String sql11 = "";
            sql11 = "select count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember member on Tbl_HHSurvey.HHSurveyGUID=member.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   member.GenderID=1 and  Tbl_HHSurvey.VillageID='" + villageID + "' and ((((Date('Now') ) - (DATE(member.DateOfBirth)) ) >=60 ) or (AprilAgeYear >=60 )) and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue11 = 0;
    ...
    public void showAllData() {
        try {
            String sql1 = "";
            sql1 = "select  count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember  on Tbl_HHSurvey.HHSurveyGUID=Tbl_HHFamilyMember.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   Tbl_HHFamilyMember.GenderID=1 and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue1 = 0;
            ivalue1 = dataProvider.getMaxRecord(sql1);
            tv_totalpopulationmale.setText(String.valueOf(ivalue1));
            String sql1female = "";
            sql1female = "select  count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember  on Tbl_HHSurvey.HHSurveyGUID=Tbl_HHFamilyMember.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   Tbl_HHFamilyMember.GenderID=2 and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue1female = 0;
            ivalue1female = dataProvider.getMaxRecord(sql1female);
            tv_totalpopulationfemale.setText(String.valueOf(ivalue1female));
            textview1.setText(String.valueOf(ivalue1 + ivalue1female));
            ...
            String sql3 = "";
            sql3 = "select count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember member on Tbl_HHSurvey.HHSurveyGUID=member.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   member.Genderid=2 and Tbl_HHSurvey.ANMID= " + anmid + " and (((Date('now') ) - (DATE(member.DateOfBirth)) >=15 and (Date('now') ) - (DATE(member.DateOfBirth)) <=49) or (AprilAgeYear >=15 and AprilAgeYear<=49) )";
            int ivalue3 = 0;
            ivalue3 = dataProvider.getMaxRecord(sql3);
            textview3.setText(String.valueOf(ivalue3));
            tv_15to49female.setText(String.valueOf(ivalue3));
            ...
            String sql4 = "";
            sql4 = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=1 and (julianday('now')  - julianday(member.child_dob))<=180 and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue4 = 0;
            ivalue4 = dataProvider.getMaxRecord(sql4);
            tv_0to6monthfemale.setText(String.valueOf(ivalue4));

            String sql4boy = "";
            sql4boy = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and    member.Gender=2 and (julianday('now')  - julianday(member.child_dob))<=180 and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue4boy = 0;
            ivalue4boy = dataProvider.getMaxRecord(sql4boy);
            tv_0to6monthmale.setText(String.valueOf(ivalue4boy));
            textview4.setText(String.valueOf(ivalue4 + ivalue4boy));
            ...
            String sql5 = "";
            sql5 = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=1 and (julianday('now')  - julianday(member.child_dob)) between 180 and 365 and Tbl_HHSurvey.ANMID= " + anmid + "";

            int ivalue5 = 0;
            ivalue5 = dataProvider.getMaxRecord(sql5);
            tv_6to1yearfemale.setText(String.valueOf(ivalue5));
            String sql5boy = "";
            sql5boy = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=2 and (julianday('now')  - julianday(member.child_dob)) between 180 and 365 and Tbl_HHSurvey.ANMID= " + anmid + "";
            ...
            textview5.setText(String.valueOf(ivalue5 + ivalue5boy));
            String sql6 = "";
            sql6 = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=1 and ((((Date('Now') ) - (DATE(member.child_dob)) ) between 0 and 2 ) )  and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue6 = 0;
            ivalue6 = dataProvider.getMaxRecord(sql6);
            tv_0to2yearfemale.setText(String.valueOf(ivalue6));
            String sql6boy = "";
            sql6boy = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=2 and ((((Date('Now') ) - (DATE(member.child_dob)) ) between 0 and 2 ) )  and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue6boy = 0;
            ivalue6boy = dataProvider.getMaxRecord(sql6boy);
            tv_0to2yearmale.setText(String.valueOf(ivalue6boy));
            textview6.setText(String.valueOf(ivalue6 + ivalue6boy));
            String sql7 = "";
            sql7 = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=1 and ((((Date('Now') ) - (DATE(member.child_dob)) ) between 1 and 3 ) )  and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue7 = 0;
            ivalue7 = dataProvider.getMaxRecord(sql7);
            tv_1to3yearfemale.setText(String.valueOf(ivalue7));
            String sql7boy = "";
            sql7boy = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=2 and ((((Date('Now') ) - (DATE(member.child_dob)) ) between 1 and 3 ) )  and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue7boy = 0;
            ivalue7boy = dataProvider.getMaxRecord(sql7boy);
            tv_1to3yearmale.setText(String.valueOf(ivalue7boy));
            textview7.setText(String.valueOf(ivalue7 + ivalue7boy));
            String sql8 = "";
            sql8 = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=1 and ((((Date('Now') ) - (DATE(member.child_dob)) ) between  4 and 6 ) )  and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue8 = 0;
            ivalue8 = dataProvider.getMaxRecord(sql8);
            tv_4to6yearfemale.setText(String.valueOf(ivalue8));
            String sql8boy = "";
            sql8boy = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=2 and ((((Date('Now') ) - (DATE(member.child_dob)) ) between  4 and 6 ) )  and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue8boy = 0;
            ivalue8boy = dataProvider.getMaxRecord(sql8boy);
            tv_4to6yearmale.setText(String.valueOf(ivalue8boy));
            textview8.setText(String.valueOf(ivalue8 + ivalue8boy));
            String sql9 = "";
            sql9 = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=1 and ((((Date('Now') ) - (DATE(member.child_dob)) ) between 0 and 6 ) )  and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue9 = 0;
            ivalue9 = dataProvider.getMaxRecord(sql9);
            tv_0to6yearfemale.setText(String.valueOf(ivalue9));
            String sql9boy = "";
            sql9boy = "select count(*) from Tbl_HHSurvey inner join tblchild member on Tbl_HHSurvey.HHSurveyGUID=member.HHGUID where Tbl_HHSurvey.IsActive=1 and   member.Gender=2 and ((((Date('Now') ) - (DATE(member.child_dob)) ) between 0 and 6 ) )  and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue9boy = 0;
            ivalue9boy = dataProvider.getMaxRecord(sql9boy);
            tv_0to6yearmale.setText(String.valueOf(ivalue9boy));
            textview9.setText(String.valueOf(ivalue9 + ivalue9boy));
            String sql10 = "";
            sql10 = "select count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember member on Tbl_HHSurvey.HHSurveyGUID=member.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   member.GenderID=1 and ((((Date('Now') ) - (DATE(member.DateOfBirth)) ) between 35 and 59 ) or (AprilAgeYear >=35 and AprilAgeYear<59)) and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue10 = 0;
            ivalue10 = dataProvider.getMaxRecord(sql10);
            tv_35to50yearmale.setText(String.valueOf(ivalue10));
            String sql10female = "";
            ...
            textview10.setText(String.valueOf(ivalue10 + ivalue10female));
            String sql11 = "";
            sql11 = "select count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember member on Tbl_HHSurvey.HHSurveyGUID=member.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   member.GenderID=1 and  ((((Date('Now') ) - (DATE(member.DateOfBirth)) ) >=60 ) or (AprilAgeYear >=60 )) and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue11 = 0;
            ivalue11 = dataProvider.getMaxRecord(sql11);
            tv_60yearmale.setText(String.valueOf(ivalue11));
            String sql11female = "";
            sql11female = "select count(*) from Tbl_HHSurvey inner join Tbl_HHFamilyMember member on Tbl_HHSurvey.HHSurveyGUID=member.HHSurveyGUID where Tbl_HHSurvey.IsActive=1 and   member.GenderID=2 and ((((Date('Now') ) - (DATE(member.DateOfBirth)) ) >=60 ) or (AprilAgeYear >=60 )) and Tbl_HHSurvey.ANMID= " + anmid + "";
            int ivalue11female = 0;
            ivalue11female = dataProvider.getMaxRecord(sql11female);
            tv_60yearfemale.setText(String.valueOf(ivalue11female));
            textview11.setText(String.valueOf(ivalue11 + ivalue11female));
