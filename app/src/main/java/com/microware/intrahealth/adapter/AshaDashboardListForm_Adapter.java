...
public class AshaDashboardListForm_Adapter extends BaseAdapter {
	...
	public AshaDashboardListForm_Adapter(Context context, ArrayList<MstASHA> ashaname) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		txtAshaName.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				global.setsGlobalAshaCode(String.valueOf(ashaname.get(position).getASHAID()));
				Intent i = new Intent(context, ReportIndicator_ashaList.class);
