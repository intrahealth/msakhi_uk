...
import com.microware.intrahealth.AF.AFAncActivity;
...
import com.microware.intrahealth.adapter.AncVisitAdapter;
...
public class AFAncAdapter extends BaseAdapter {
    ...
    public AFAncAdapter(Context context, ArrayList<tbl_pregnantwomen> pregnant) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            gridview = layoutInflater.inflate(R.layout.af_ancgridadapter, null);
        } else {
        ...
        tvwname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((AFAncActivity) context).openExpendableGridView(position);
