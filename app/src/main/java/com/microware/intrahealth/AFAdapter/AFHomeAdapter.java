...
public class AFHomeAdapter extends BaseAdapter {
    ...
    public AFHomeAdapter(Context context, ArrayList<tbl_pregnantwomen> pregnant) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            gridview = layoutInflater.inflate(R.layout.af_homegridadapter, null);
        } else {
        ...
        tvwname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                ((AFHomeVisit) context).openExpendableGridView(position);
