...
import com.microware.intrahealth.AFAdapter.AFPnc_WomenAdapter;
import com.microware.intrahealth.Dashboard_Activity;
import com.microware.intrahealth.Global;
import com.microware.intrahealth.HomeVisitDashboard;
...
public class AFPncWomenList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.af_home_activity);
    ...
    public void fillgrid(int flag) {
        ...
        if (Child != null) {
            ...
            totalcount.setText(getResources().getString(R.string.totalcount)
                    + "-" + Child.size());
            gridanc.setAdapter(new AFPnc_WomenAdapter(this, Child));
        }
    }
...
//
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        if (flag == 1) {
            Intent i = new Intent(AFPncWomenList.this, Dashboard_Activity.class);
            finish();
            i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(i);
        } else {
            Intent i = new Intent(AFPncWomenList.this, HomeVisitDashboard.class);
            finish();
            i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(i);
        }
