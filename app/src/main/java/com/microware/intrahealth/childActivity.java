...
public class childActivity extends Activity {
    ...
    Spinner spinBirthPlace, spinChildGender, spinBreastFeeding,
            ...
            spinBreastFeeding3, spinVaccination3, spinfacility, spinDeliveryType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinDeliveryType = (Spinner) findViewById(R.id.spinDeliveryType);
        ...
        tbl_DeliveryType = (TableRow) findViewById(R.id.tbl_DeliveryType);
        ...
        btnNotverified.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Validate.verification(global.getUserID(), 2, global.getsGlobalChildGUID(), 1, global.getsGlobalAshaCode(), global.getAnmidasAnmCode(), validate.RetriveSharepreferenceString("AFID"), btnNotverified, btnVerifiedOk, btnVerifiedNotOk);
            }
        });
        ...
        btnVerifiedOk.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btnVerifiedNotOk.setBackgroundColor(getResources().getColor(R.color.lightgray));
                Validate.verification(global.getUserID(), 2, global.getsGlobalChildGUID(), 2, global.getsGlobalAshaCode(), global.getAnmidasAnmCode(), validate.RetriveSharepreferenceString("AFID"), btnNotverified, btnVerifiedOk, btnVerifiedNotOk);
            }
        });
        btnVerifiedNotOk.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Validate.verification(global.getUserID(), 2, global.getsGlobalChildGUID(), 3, global.getsGlobalAshaCode(), global.getAnmidasAnmCode(), validate.RetriveSharepreferenceString("AFID"), btnNotverified, btnVerifiedOk, btnVerifiedNotOk);
            }
        });
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if (position > 0) {
                    if (returnid(position - 1, 12, global.getLanguage()) == 2) {
                        ...
                        tbl_DeliveryType.setVisibility(View.VISIBLE);
                    } else {
                        tblfacility.setVisibility(View.GONE);
                        tblfacilitytype.setVisibility(View.GONE);
                        etfacility.setText("");
                        tbl_DeliveryType.setVisibility(View.GONE);
                        spinfacility.setSelection(0);
                        spinDeliveryType.setSelection(0);
                    }
                } else {
                    tblfacility.setVisibility(View.GONE);
                    tblfacilitytype.setVisibility(View.GONE);
        ...
        fillCommonRecord(spinDeliveryType, 50);
    ...
    public int sCheckValidation() {
        ...
        if (etWeightChild2.getText().toString() != null
                && etWeightChild2.getText().toString().length() > 0) {
            weight1 = Float.valueOf(etWeightChild2.getText().toString());
        }
        if (etWeightChild3.getText().toString() != null
                && etWeightChild3.getText().toString().length() > 0) {
            weight2 = Float.valueOf(etWeightChild3.getText().toString());
        }
        ...
        if (spinnumberofnewborn.getSelectedItemPosition() == 2
                && (etWeightChild2.getText().toString() == null
                || etWeightChild2.getText().toString().length() == 0 || weight1 < 1)) {
            return 4;
        }
        if (spinnumberofnewborn.getSelectedItemPosition() == 2
        ...
        if (spinnumberofnewborn.getSelectedItemPosition() == 3
                && (etWeightChild3.getText().toString() == null
                || etWeightChild3.getText().toString().length() == 0 || weight2 < 1)) {
            return 4;
        }
        if (spinnumberofnewborn.getSelectedItemPosition() == 3
    ...
    public void showAlert(int iCheck) {
        if (iCheck == 2) {
            ...
            CustomAlertSave2(getResources()
                    .getString(R.string.PleaseselectDeliveryType));
        }
    ...
    public void save() {
        ...
        int created_by = Validate.returnIntegerValue(global.getsGlobalUserID());
        String modified_on = Validate.getcurrentdate();
        int modified_by = Validate.returnIntegerValue(global.getsGlobalUserID());
        int AshaID = 0;
        int ANMID = 0;
        // add field
        String dpt1 = "";
        ...
        if (spinDeliveryType.getSelectedItemPosition() > 0) {
            Common = dataProvider.getCommonRecord(1, 50);
            DeliveryType = Common.get(
                    spinDeliveryType.getSelectedItemPosition() - 1).getID();
        }
        String flag = "I";
        ...
        if (global.getsGlobalChildGUID() != null
            ...
            String sql = "Select Child_dob from tblChild where ChildGUID ='"
                    + global.getsGlobalChildGUID() + "'";
            String dob = dataProvider.getRecord(sql);
            if (!dob.equalsIgnoreCase(Validate.changeDateFormat(Child_dob))) {
                dataProvider.updatevaccine(global.getsGlobalChildGUID(), dpt1,
                        opv2, dpt2, hepb2, opv3, dpt3, hepb3, measeals,
                        vitaminA, opv4, hepb4, Pentavalent1, Pentavalent2,
                        Pentavalent3, IPV, DPTBooster, OPVBooster,
                        MeaslesTwoDose, VitaminAtwo, DPTBoostertwo, ChildTT,
                        JEVaccine1, JEVaccine2, VitaminA3, VitaminA4,
                        VitaminA5, VitaminA6, VitaminA7, VitaminA8, VitaminA9,
                        TT2);
            }
            ...
            if (spinnumberofnewborn.getSelectedItemPosition() > 0) {
                ...
                if (spinnumberofnewborn.getSelectedItemPosition() == 1) {
                    ...
                    dataProvider.SavetblChild("I", AshaID, ANMID, ChildGUID,
                            ...
                            modified_by, FacilityType, Facility, DeliveryType);

                    global.setsGlobalChildGUID(ChildGUID);
                    dataProvider.InsertFamilymemberDetails(AshaID, ANMID,
                            "111111111111", child_name, 1,
                            Validate.changeDateFormat(Child_dob),
                            HHFamilyMemberGUID, 1, gender(Gender), 2, 1,
                            HHGUID, ChildGUID, created_by, flag, MotherGUID);
                    ...
                    dataProvider.InsertFamilymemberDetails(AshaID, ANMID,
                            ...
                            HHGUID, ChildGUID, created_by, flag, MotherGUID);
                    global.setsGlobalChildGUID(ChildGUID);
                    String childguid2 = Validate.random();
                    dataProvider.SavetblChild("I", AshaID, ANMID, childguid2,
                            pw_GUID, HHGUID, HHFamilyMemberGUID, MotherGUID,
                            Date_Of_Registration,
                            ...
                            modified_on, modified_by, FacilityType, Facility, DeliveryType);

                    dataProvider.InsertFamilymemberDetails(AshaID, ANMID,
                            "111111111111", child_name2, 1,
                            Validate.changeDateFormat(Child_dob),
                            HHFamilyMemberGUID, 1, gender(Gender2), 2, 1,
                            HHGUID, childguid2, created_by, flag, MotherGUID);
                    ...
                    dataProvider.InsertFamilymemberDetails(AshaID, ANMID,
                            ...
                            HHFamilyMemberGUID, 1, gender(Gender2), 2, 1,
                            HHGUID, childguid2, created_by, flag, MotherGUID);
                    String childguid3 = Validate.random();
                    dataProvider.SavetblChild("I", AshaID, ANMID, childguid3,
                            pw_GUID, HHGUID, HHFamilyMemberGUID, MotherGUID,
                            Date_Of_Registration,
                            ...
                            modified_on, modified_by, FacilityType, Facility, DeliveryType);
                    dataProvider.InsertFamilymemberDetails(AshaID, ANMID,
                            "111111111111", child_name3, 1,
                            Validate.changeDateFormat(Child_dob),
                            HHFamilyMemberGUID, 1, gender(Gender3), 2, 1,
                            HHGUID, childguid3, created_by, flag, MotherGUID);
                }
            }
        }
        String sql = "update  tblpregnant_woman set deliverydatetime='"
                + Validate.changeDateFormat(Child_dob) + "',deliveryplace='"
                + place_of_birth + "',IsPregnant=0 ,IsEdited=1 where pwguid='" + pw_GUID
                + "'";
    ...
    public void showdata() {
        ...
        if (Child != null && Child.size() > 0) {
            ...
            spinfacility.setSelection(returnpos(Child.get(0).getFacilityType(),
                    28));
            spinDeliveryType.setSelection(returnpos(Child.get(0).getDeliveryType(),
                    50));
        ...
        if (global.getiGlobalRoleID() == 4) {
            String sVerify = "Select Verify from tblAFVerify where ModuleGUID='" + global.getsGlobalChildGUID() + "'";
