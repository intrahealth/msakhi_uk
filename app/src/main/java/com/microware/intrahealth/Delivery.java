...
public class Delivery extends Activity {
	...
	public void savedata() {
		...
		if (radioAbortion.isChecked()) {
			...
			String sql1 = "update tblPregnant_woman set  IsPregnant=0,Abortion_FacilityName="
					+ Abortion_FacilityName + " ,IsEdited=1 where PWGUID='" + PWGUID + "'";
		...
		if (radioMaternaldeath.isChecked()) {
			...
			dataProvider.executeSql(sql1);
			String sql2 = "update tblPregnant_woman set  IsPregnant=0 ,IsEdited=1 where PWGUID='"
					+ PWGUID + "'";
	...
	public void onBackPressed() {
		...
		Intent i = new Intent(Delivery.this, AncActivity.class);
		finish();
		startActivity(i);
	}
}