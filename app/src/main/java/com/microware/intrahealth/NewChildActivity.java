...
public class NewChildActivity extends Activity {
    ...
    Global global;
    TableRow tblfacilitytype, tblfacility, tblBcg, tblOpv, tblHep, tbl_DeliveryType;
    TextView tvDateOfBirth;
    Spinner spinChildGender, spinBirthPlace, spinfacility, spinVaccination, spinDeliveryType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDateOfBirth.setOnClickListener(new OnClickListener() {
    ...
    public void showAlert(int iCheck) {
        if (iCheck == 2) {
            ...
            CustomAlertSave2(getString(R.string.PleaseselectDeliveryType));
        }
    }
    ...
    public void save() {
        ...
        if (global.getsGlobalChildGUID() != null
            ...
            dataProvider.SavetblChildnew("I", AshaID, ANMID, ChildGUID,
                    ...
                    FacilityType, Facility, bcg, opv1, hepb1, DeliveryType);
            dataProvider.InsertFamilymemberDetails(AshaID, ANMID,
                    "111111111111", child_name, 1,
                    Validate.changeDateFormat(Child_dob), HHFamilyMemberGUID,
