...
public class NCD_AA extends FragmentActivity implements ActionBar.TabListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (global.getiGlobalRoleID() == 2) {
            mActionBar.addTab(mActionBar.newTab()
                    .setText(getString(R.string.ncdcbac))
                    .setTabListener(this));
        } else if (global.getiGlobalRoleID() == 3) {
            mActionBar.addTab(mActionBar.newTab()
                    .setText(getString(R.string.HouseholdMember))
                    .setTabListener(this));
        }
    ...
    class TabsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int index) {
            switch (index) {
                case 0:
                    return new NCD_Member();
                case 1:
                    return new NCD_Patient();
            }
            return null;
        }
    ...
    protected void onStart() {
        ...
        if (networkInfoCheckConnection != null
            ...
            try {
                GoogleAnalytics.getInstance(NCD_AA.this).reportActivityStart(
                        this);
    ...
    protected void onStop() {
        ...
        if (networkInfoCheckConnection != null
                ...
                && networkInfoCheckConnection.isAvailable()) {
            try {
                GoogleAnalytics.getInstance(NCD_AA.this)
    ...
    public void onBackPressed() {
        ...
        if (global.getiGlobalRoleID() == 3) {
            Intent i = new Intent(NCD_AA.this, AshaListForAnm.class);
            finish();
            i.putExtra("Flag", 6);
            startActivity(i);
        } else {
            Intent i = new Intent(NCD_AA.this, Dashboard_Activity.class);
            finish();
            startActivity(i);
        }
