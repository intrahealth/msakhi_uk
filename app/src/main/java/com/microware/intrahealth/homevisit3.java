...
public class homevisit3 extends Activity {
	...
	private static String[] images = {
			...
			"प्रसव पश्चात जांच ", "जन्म की सूचना आशा और एएनएम को दें  ",
			"नए जन्मे बच्चे की देखभाल ", "नए जन्मे बच्चे को गर्म रखें ",
			"जन्म के एक घंटे के अन्दर स्तनपान कराएं ",
			"नए जन्मे बच्चे की नाल को साफ़ और सूखा रखें ",
			"पोषक और संतुलित भोजन करें ",
			"आशा को आप और आपके बच्चे को घर पर देखने के लिए कहें ",
			"नए जन्मे बच्चे में खतरे के लक्षण ",
			"	प्रसव पश्चात परिवार नियोजन ",
			"इन खतरे के लक्षणों में डॉक्टर या एएनएम से संपर्क करें ",
			"तेज सांस या पसली धंसना ", "सांस लेने में तकलीफ ",
			"नवजात ठीक से न चूस पाए ",
			"सामान्य से अधिक सुस्त रहना या लगातार रोना   ",
			"हथेली और तलवों में पीलापन ", "दौरे पड़ना ",
			"नवजात को छूने से गर्म या ठंडा महसूस हो ", "लैट्रिन में खून आना ",
			"प्रसव के बाद माँ में खतरे के लक्षण ",
			"इन खतरे के लक्षणों में डॉक्टर या एएनएम से संपर्क करें ",
			"योनि से अत्यधिक खून आना ", "चैतन्यता कम होना ",
			"दौरे आना या फिट्स पड़ना ", "योनि से बदबूदार स्राव होना ", "बुखार ",
			"पेट में तेज दर्द ", "सांस लेने में तकलीफ या तेज सांस चलना ",
			"परिवार नियोजन का महत्व 	 ", "गर्भावस्था में अनुचित अंतर ",
			"प्रसव पश्चात परिवार नियोजन ", "गर्भ निरोधन के स्थाई साधन ",
			"महिला नसबंदी ", " डॉक्टर से नसबंदी ",
			"7 दिनों या घंटों में या 6 सप्ताह बाद ",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// "page6"};
		adapter = new TouchImageAdapter(homevisit3.this);
 ...
 class TouchImageAdapter extends PagerAdapter {
		...
		public View instantiateItem(ViewGroup container, int position) {
			...
			tvdateans.addTextChangedListener(new TextWatcher() {
				...
				public void afterTextChanged(Editable s) {
					...
					datatv = Validate.changeDateFormat(tvans.getText()
							.toString());
			...
			// if(position==16){
			// try {
			// String name = ja.getJSONObject(0).getString("AncCheckup2YN");
			// String name2 = ja.getJSONObject(0).getString("AncCheckup2");
			//
			// tvdatatv.setText(name2);
			// // if(name2.length()>0){
			// // tvdateans.setText(Validate.changeDateFormat(name2));
	...
	public void onBackPressed() {
		...
		Intent in = new Intent(homevisit3.this, HomeVisit.class);
		finish();
		startActivity(in);
	}
	...
	public void mynextPage() {
		...
		savedata(currentPage, tvdata.getText().toString(),
				tvdatatv.getText().toString());
		int tempdata = 0;
	...
	public void savedata(int pos, String data, String datatv) {
		...
		// }
			...
			// }else if(pos==16){
			//
			// sql = "update tblANCVisit set AncCheckup2YN=" + newdata
			// + ",AncCheckup2='"+datatv+"' where VisitGUID='" +
			// global.getsGlobalANCVisitGUID()
			// + "'and PWGUID='"+global.getsGlobalPWGUID()+"'";
			// System.out.println(sql);
			// dataProvider.executeSql(sql);
